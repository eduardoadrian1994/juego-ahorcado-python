...
1. Debes seleccionar de qué conjunto de palabras quisieras jugar en 3.ajustes(contraseña es 1) > 2.crear grupos de palabras(creas primero el nombre del grupo y despues la palabras a divinar )
"advertencia ten encuenta si pones muchas palabras se elijira una al azar para jugar2"  > ingresas 1.jugar
2. Inicias con """ + str(intentos) + " vidas" + """
3. Ingresa una letra por vez que creas vaya en la palabra a adivinar Suerte con el juego""")
...
def menu_principal():
    menu = """
Ingresa primero a las instrucciones para poder jugar.
1. Jugar
2. Instrucciones
3. Ajustes
4. Salir
